...
table2 %>% 
  left_join(nicknames) %>%
 inner_join(muni_shp, by = c("shpfile_name" = "MUNICIPALITY")) %>%
...
## Slides \_\_\_: Impact on Composite Tax Rate
...
## Slides \_\_\_\_ : Change in Tax Burden
...
burden %>% 
 ...
 # filter(incentive == "Incentive" & Alea_cat == "Industrial"  & clean_name !="NA") %>%
  ...
  labs(title = "Tax Burden for owner-occupied Properties",
       subtitle = "Ordered by Current Tax Burden", x = "% of Levy Paid", y = "" , 
       caption = "")
```
