...
::: callout-warning
Do not double count untaxable value when adding value in TIFs and incentive class property value.
:::
...
ptax_pins <- ptax_pins %>% 
  ...
  mutate(
   ...
   untaxable_value_eav = ifelse(class == 239, equalized_av-taxed_eav, untaxable_value_eav), 
    ...
    fmv_incents_inTIF = ifelse(between(class, 600, 900) & in_tif == 1, fmv, 0),
