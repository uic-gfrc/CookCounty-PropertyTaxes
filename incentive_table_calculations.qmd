...
stopifnot(
 ...
 # (ptax_pins$equalized_av - ptax_pins$taxed_eav <= 1000),
  (ptax_pins$taxed_eav - ptax_pins$equalized_av <= 10)
)

stopifnot(
  ((ptax_pins$taxed_eav + ptax_pins$untaxable_value_eav) -  ptax_pins$equalized_av > 500 )
)

stopifnot(
  ptax_pins$taxed_eav + ptax_pins$untaxable_value_eav - ptax_pins$equalized_av > 50
)
```
