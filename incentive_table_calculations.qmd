...
table_cook %>% 
  ...
  set_header_labels(cty_PC = 'PINs', cty_projects = "Project IDs", 
                    cty_fmv = 'Total FMV', 
                    cty_fmv_taxed = 'Taxed FMV', fmv_untaxable_value = 'Value not Taxable\nfor Levy',
...
table_cook %>% 
  select(cty_fmv, cty_fmv_inTIF, cty_fmv_tif_increment, cty_fmv_incentive, cty_fmv_incents_inTIFs) %>%
  flextable() %>% 
  set_header_labels(
                    cty_fmv = 'Total FMV', 
                    ...
                    cty_fmv_incents_inTIFs = 'FMV with Incent. Class. in TIFs'
)%>%   FitFlextableToPage()
