...
source("helper_tc_muninames.R") #modified the helperfile to generate this QMD. Did not save or push the change.
...
incentive_pins %>% 
  ...
  geom_point(aes(size = AvgIncent, fill = triad_name), alpha = .7) +
  scale_fill_identity()
