...
#| tbl-cap: "2022 observations only - Growth from 2011. Removes Excluded observations from Land Use categories and Incentive Change Categories."

model_df <- comm_ind %>% filter( year == 2022 & land_use != "Excluded" & incent_change != "Excluded" & landuse_change != "Excluded") 
