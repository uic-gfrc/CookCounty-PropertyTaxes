...
muni_fe_new_vars_mods <- list(
  "Industrial Subset" = feols(fmv_growth_2011 ~ incent_change_bin*prop_use_change_bin
                 | clean_name + year,  vcov = "twoway",
                              data = industrial_subset |> filter(fmv_growth_2011 < 10000)  ),
  "Commercial Subset" = feols(fmv_growth_2011 ~ incent_change_bin*prop_use_change_bin
                 | clean_name + year,  vcov = "twoway",
                              data = commercial_subset |> filter(fmv_growth_2011 < 10000)  )
)
modelsummary(muni_fe_new_vars_mods,
             stars = TRUE,
             fmt = function(x) round(x, 2),
