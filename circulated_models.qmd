...
# NOTE: MADE USING THE 2023 PTAXSIM.DB AND THUS 2023 OBS MUST BE FILTERED OUT.
...
## Random Tables I Didn't Want to Delete
...
formatted_id_test <- modelsummary(panel_id_test,
             shape = "cbind",
             fmt = function(x) round(x, 2),
            # gof_map = gof_mm,
             stars = TRUE)
