...
incent_paper_models <- list(
  ...
  "Model A (PINs)" = feols(fmv_growth_2011_w ~ incent_prop + land_use +
  ...
  "Model B (PINs)" = feols(fmv_growth_2011_w ~ incent_prop + land_use +
  ...
  "Model A (Municipalities)" = 
    ...
    feols(fmv_growth_2011_w ~ incent_prop + land_use +
            land_use*incent_change
                           | clean_name + year,
                           panel.id = ~clean_name + year,
                           vcov = "DK",
                           data = comm_ind),
  
   "Model B (Municipalities)" = 
