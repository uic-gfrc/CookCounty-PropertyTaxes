...
muni_fe_models <- list(
      ...
      "3" = feols(fmv_growth_2011_w ~ incent_prop*land_use | clean_name + year,
                       ...
                       data = comm_ind_df  ),
          "4" = feols(fmv_growth_2011_w ~  incent_prop*land_use + in_tif + triad*reassessed_year | clean_name + year,
                                                           vcov = "twoway",
...
muni_fe_models <- list(
      ...
      "1" = feols(fmv_growth_2011_w ~ land_use + triad*reassessed_year + 
                   triad*l(reassessed_year, 1:2) 
                  | pin  + triad^year^reassessed_year + clean_name ,
                panel.id = c("pin", "year"), 
                       data = comm_ind_df ),
...
pooled_ols_models <- list(
  ...
  "3" = feols(fmv_growth_2011_w ~ land_use + incent_prop + land_use*incent_prop + base_year_fmv_2011,
              data = comm_ind_df)
