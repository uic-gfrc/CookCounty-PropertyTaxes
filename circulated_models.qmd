...
incent_paper_models <- list(
  ...
  "Municipality-Level" = list(
    ...
    "I" = feols(fmv_growth_2011 ~ incent_prop + land_use                            | clean_name + year,
...
model_df <- comm_ind %>% filter( year == 2022 & land_use != "Excluded" & incent_change != "Excluded" & landuse_change != "Excluded" & incent_status != "Excluded") 
