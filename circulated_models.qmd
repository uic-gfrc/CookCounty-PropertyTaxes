...
comm_ind_raw |>
      filter(year == 2022)|>
  ggplot() +
  geom_freqpoly(aes(fmv_growth_2011_w, color = "FMV Growth 2011")) +
  geom_freqpoly(aes(base_year_fmv_2011_w, color = "FMV 2011")) +
  labs(
...
comm_ind_raw |>
      filter(year == 2022)|>
  filter(fmv_growth_2011_w < 20000) |>
  filter(base_year_fmv_2011_w < 200000000) |>
  ggplot() +
