...
#| tbl-cap: "2011 and 2022 observations only."

model_df <- comm_ind %>% filter( year == 2022)

ols_models <- list(
    "1" = lm(fmv_growth_2011_w ~  incent_status,
                data = model_df),
  
  "2" = lm(fmv_growth_2011_w ~ landuse_change,
                data = model_df),
  
    "3" = lm(fmv_growth_2011_w ~ landuse_change*incent_status,
                data = model_df)
  )
