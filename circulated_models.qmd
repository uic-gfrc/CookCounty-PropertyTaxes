...
mod1 <- fixest::feglm(incent_indicator ~ land_use + reassessed_year | pin + clean_name + year,
                                          panel.id = c("pin", "year"),   
                      data = comm_ind_raw, 
...
muni_fe_new_vars_mods <- list(
  ...
  "Industrial Subset, Muni&PIN FE" = feols(fmv_growth_2011_w ~ land_use*incent_prop + in_tif
