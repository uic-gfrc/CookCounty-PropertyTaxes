...
left_join(NBHs, by = c("nbhd_code" = "town_nbhd")) %>%
  ...
  ggplot() +
  geom_sf(aes(geometry = geometry, fill = nbh_TIF_PC), color = "black") +
  theme_void() + 
  theme(axis.ticks = element_blank(), axis.text = element_blank())+
  scale_fill_steps2(
        high = "brown", low = "black",
...
left_join(NBHs, by = c("nbhd_code" = "town_nbhd")) %>%
  ...
  ggplot() +
  geom_sf(aes(geometry = geometry, fill = nbh_FMV), color = "black") +
  theme_void() + 
  theme(axis.ticks = element_blank(), axis.text = element_blank())+
  scale_fill_steps2(
        high = "brown", low = "black",
...
> WHY are there some neighobrhoods that are gray??  Implies they didn't match during the join. CHECK.
