...
#| tbl-cap: "Aggregate FMV Growth from 2011 to 2022 by `incent_status`. Calculations for PINs counts in header of table in report."
...
```{r}
#| label: fig-growth-facetby-incentchange-clean
...
df_2011_v2_bal %>%  
  filter(landuse_change != "Excluded" & landuse_change != "Exempt Sometime") %>%
  ...
  labs(title= "Aggregate FMV Growth - Indexed to 2011 Values", 
       subtitle = "Incentive Classification Status by Land Use Change",
       y = "FMV Growth since 2011", x = NULL,
       caption =  "Values are indexed to 2011 FMV. Only uses PINs that existed 
       all years of the sample. Excludes PINs that either did not exist for all
       years in the sample or were tax exempt for some years.") +
...
#| fig-cap: "**Aggregate FMV Growth from 2011 to 2022** Faceted by if a PIN  incentive status during the sample period. Indexed to fair market value during 2011."
df_2011_bal %>%  
