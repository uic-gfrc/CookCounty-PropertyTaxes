...
comm_ind_pins <- comm_ind_pins %>% 
 ...
 classpins_per_year <- comm_ind_pins |>
  ...
  summarize("Becomes 8" = sum(becomes8==1, na.rm=TRUE),
            ...
            "6 or 7 to 8" = sum(switches_to8, na.rm=TRUE),
            "6 or 7 to 8lag" = sum(switchto8lag, na.rm=TRUE),
...
> note to self: status is coded incorrectly. There are 'Gains Incentive' PINs that are also Controls if they existed less than 12 years. 

> Became_taxed is wrong too
