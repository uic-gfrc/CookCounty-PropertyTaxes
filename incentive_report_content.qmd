...
df_2011 %>% 
  ...
  ggplot() + geom_line(aes(x=year, y=n_group_growth, group = incent_status, color = incent_status)) + scale_y_continuous(limits = c(0.8,2.5)) + 
...
df_2011 %>% 
ggplot() + geom_line(aes(x=year, y=fmv_group_growth, group = incent_prop, color = incent_prop)) + theme_bw() + facet_wrap(~land_use)
