...
table(amazon_geo2$year, amazon_geo2$major_class_code)
library(ggspatial)
...
ggplot() + geom_line(aes(x=year, y=fmv_group_growth, group = land_use, color = land_use)) + facet_wrap(~incent_prop) + labs(title= "Growth from 2006 to 2022")
