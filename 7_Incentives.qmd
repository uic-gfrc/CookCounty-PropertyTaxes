...
incentive_taxbills <- tax_bill(2008:2021, incentive_pins$pin, simplify = FALSE)
...
incent_pins_ptax %>%  group_by(year) %>%
...
```
```{r}
#| label: fig-muni-avappeals
#| column: page
#| layout-ncol: 2
#| fig-cap: "Appeals & Incentive Properties"
