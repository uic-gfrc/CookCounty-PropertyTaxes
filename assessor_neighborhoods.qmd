...
```
```{r eval=FALSE}
write_csv(nbh_sum_new_exe, "nbh_sum_new_exe.csv")
write_csv(Current_Taxrates_per_nbh, "Current_Taxrates_per_nbh.csv")
write_csv(Current_Taxrates_per_nbh_TC, "Current_Taxrates_per_nbh.csv")
```
...
```{r}
nbh_sum_new_exe <- read_csv("nbh_sum_new_exe.csv") %>% mutate(nbhd_code = as.character(nbhd_code))
...
```{r}
Current_Taxrates_per_nbh <- read_csv("Current_Taxrates_per_nbh.csv") %>% mutate(nbhd_code = as.character(nbhd_code))
