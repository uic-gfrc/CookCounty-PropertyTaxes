...
### Slide 6 - Share of Muni Industrial and Commercial FMV with incentive class

> TO DO: Calculate the percents out of each group's FMV instead of the municipalities FMV?

> Take from Incentives in TIFs file

### Share of Municipality Total FMV with incentive classifications 
...
pct_fmv_w_incent = fmv_w_incent/comind_fmv)  %>%
 # select(-av_incent) %>% 
  select(clean_name, comind_fmv, pct_fmv_w_incent, pin_count, project_count, pins_inTIF)
