...
(taxed_av*eq2022/loa)*0.25, taxed_av*eq2022)),
  ...
  # mutate(pct_PC_proptype = classgroup_PC/cty_PC,
  #        pct_fmv_incentive = fmv_incentive / cty_fmv,
  #        pct_fmv_taxed = fmv_taxed / cty_fmv,
  #        pct_fmv_inTIF = fmv_inTIF / cty_fmv,
  #        pct_fmv_tif_increment = fmv_tif_increment / cty_fmv,
  #        pct_fmv_untaxable = fmv_untaxable_value / cty_fmv,
  #        pct_fmv = fmv / cty_fmv,
  #        pct_zero_bill = zero_bill / cty_zero_bill,
  #        pct_PC_withincents = pins_withincents / cty_PC_incent,
       #  pct_fmv_incents_inTIF = fmv_incents_inTIFs / cty_fmv_incents_inTIFs,
       #  pct_eav_incents_inTIF = eav_incents_inTIFs /cty_eav,
#pct_eav_taxed = eav_taxed / cty_eav_taxed
 # )
