...
forgonerev_from_comind_incents  = sum(ifelse(class >= 600 & class < 900,
      (((taxed_av*eq2022/loa)*0.25 - (taxed_av*eq2022/loa))) * tax_code_rate/100, 0), na.rm=TRUE),
...
cook_ratechange %>% 
select(rate_current, rate_noInc, change_noInc, forgonerev_from_comind_incents, forgonerev_commerc_incents, forgonerev_indust_incents, reducedEAV_commerc_incents, reducedEAV_indust_incents, reducedEAV_comind_incents)
