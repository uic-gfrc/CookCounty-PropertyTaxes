...
writexl::write_xlsx(keypincheck, "Output/project_check3.xlsx")
```
...
manually_checked <- readxl::read_xlsx("Output/projects_combined_with_municipality.xlsx", col_types = "text")|>
  mutate(pin = str_pad(pin, 14, side = "left", pad = "0"),
         keypin = str_pad(keypin, 14, side = "left", pad = "0")) |> 
