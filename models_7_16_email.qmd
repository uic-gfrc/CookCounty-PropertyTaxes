...
```{r plm-munidummy-comparison}
#| 
plm(fmv_growth_2011 ~ change_incent_bin + fmv_2011 + Triad 
                   + change_prop_use_bin + land_use + in_tif,
    model = "within",
    effect = "individual",
                    data = df_2022)
...
# muni_dummy_models <- c(muni_dummy_1, muni_dummy_2, muni_dummy_3, muni_dummy_4, muni_dummy_5)
# modelnames <- c("Base", "1", "2", "3",  "4")
# 
# muni_dummies_table <-
#   export_summs(muni_dummy_models,
