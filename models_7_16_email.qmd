...
ind_1 <- lm(fmv_growth_2011 ~ incent_change + clean_name,
                data = df_2022_ind)

summary(ind_1)

ind_2 <- lm(fmv_growth_2011 ~ incent_change + fmv_2011 + clean_name,
                data = df_2022_ind)

summary(ind_2)

ind_3 <- lm(fmv_growth_2011 ~ incent_change + fmv_2011 + triad 
                   + clean_name,
                data = df_2022_ind)

summary(ind_3)

ind_4 <- lm(fmv_growth_2011 ~ incent_change + fmv_2011 + triad 
                   + change_prop_use_bin + clean_name,
                data = df_2022_ind)

summary(ind_4)

ind_5 <- lm(fmv_growth_2011 ~ incent_change + fmv_2011 + triad 
                   + change_prop_use_bin + in_tif 
                   + clean_name,
                data = df_2022_ind)
...
ind_6 <- lm(fmv_growth_2011 ~ incent_change + fmv_2011 + Triad 
                   + change_prop_use_bin + in_tif 
                   + clean_name,
                data = df_2022_ind)
