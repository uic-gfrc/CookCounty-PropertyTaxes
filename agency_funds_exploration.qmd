...
eligible |> 
  filter(fund408==0 | is.na(levy_adjustment)) |> distinct(agency_name, year) |> DT::datatable(rownames = FALSE)

eligible |> 
  filter(levy_adjustment==0 | is.na(levy_adjustment)) |> distinct(agency_name) |> DT::datatable(rownames = FALSE)
