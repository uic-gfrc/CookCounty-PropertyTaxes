...
agency_info <- DBI::dbGetQuery(
  ...
  mutate(pct_inCook = round(cty_cook_eav / cty_total_eav, digits = 3) )
...
adjust_all <- rbind(adjust2021, adjust2022, adjust2023, adjust2024) |>
  ...
  mutate(recap_levyshare = round(levy_adjustment/lastyear_levy, digits = 5)) |> 
  # fix agency names
...
final_df_temp <- final_df |>
  rename(agency_name = agency_name.x)
  # select(year, 
  #        agency_number, 
