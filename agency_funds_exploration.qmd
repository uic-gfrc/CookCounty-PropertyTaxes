...
# ACTUALLY the value of refunds that were recaptured and added to the levy value, not actual refunds amounts
# 
...
df |>
  group_by(year, adjust_eligible) |>
  reframe(year, adjust_eligible, perc_levy_ref = sum(abs(total_refund), na.rm = T)/sum(levy, na.rm = T)) |>
