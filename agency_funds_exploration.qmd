...
```{r}
#| tbl-cap: "Recapture Levy Share for tax year 2024. Uses levy amount from fund 408 / total_final_levy to create recap levyshare. Only PTAXSIM data." 
...
refund_all |> 
  ...
  mutate(share = abs(total_refunds)/total_final_levy,
         share = ifelse(share>1, 1,share),
         year = as.character(year)) |>
  filter(year !="2024") |> DT::datatable(rownames = FALSE)
```
