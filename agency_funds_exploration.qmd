...
refund2020 <- readxl::read_xlsx("PTAB/levy recapture/Levy Recapture - vf2 as received from CCTO 2022-03-23.xlsx")|>
  mutate(year = 2021) |>
  select(-Total)
...
refund_all <- rbind(refund2020, refund2021, refund2022, refund2023) |>
...
# final_df <- final_df   |>
#   mutate(
#     # MVH QUESTIONS IF THIS IS A GOOD IDEA
#     ptab_refund = ifelse(is.na(ptab_refund), ptab_recap,
#                                 ptab_refund),
#     coe_refund = ifelse(is.na(coe_refund), coe_recap,
#                                coe_refund),
#     total_refund = ptab_refund + coe_refund,
#     
#     levy_adjustment= ifelse(is.na(levy_adjustment), 0, levy_adjustment)) |>
...
#   # THIS IS A BRAND NEW MUTATE MVH 4/17
# No agencies were eligible for recapture before 2021, so maybe leaving them as NA makes the most sense?
#   mutate(adjust_eligible = ifelse(is.na(adjust_eligible), "Not Eligible", adjust_eligible))
