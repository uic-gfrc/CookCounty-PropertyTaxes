...
```{r}
#| label: fig-buyernamesdefault-andtouches
#| fig-cap: "Default group is from buyer name in sales data. If missing sale buyer name, then the ID uses the group variable for if a PIN touches other PINs. Color fill uses the created ID."
...
```{r}
#| label: fig-touchespin-elkgrove-borid
#| fig-cap: "Elk Grove mapped by Board of Review Appellant name and then if the PIN is touching or not."
#| 
...
```{r}
#| label: fig-touchespin-elkgrove-appellantname
#| fig-cap: "Elk Grove mapped by if PINs touch. Not the default method for making project IDs."
#| layout-ncol: 2
...
#| fig-cap: "Elk Grove mapped by Board of Review Appellant name. Only shows projects with more than 1 pin."
#| layout-ncol: 2
...
```{r}
#| label: fig-appellantgroups
#| fig-cap: "Elk Grove mapped by appellant name. Only shows projects with more than one pin."
...
#| fig-cap: "Elk Grove mapped by sale buyer name&ifpins touch. Only shows projects with more than 1 PIN"
#| layout-ncol: 2
...
#| fig-cap: "Elk Grove mapped by Buyer's name. Only shows projects with more than 1 PIN"
#| layout-ncol: 2
