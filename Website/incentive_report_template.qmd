...
figure9_data  |>
  ...
  scale_fill_identity(labels = rev(c(
    "No Exemptions",
    "No Incentive Classes",
    "Current Rate")
  ),
 # breaks = dotcolor, #c("No Exemptions", "No Incentives", "Current Rate"),
  guide = "legend") +
  scale_x_continuous(labels = scales::percent) +
  scale_y_discrete(labels = label_vec) + 
  labs(#title = "Composite Tax Rate Scenarios",
...
file_name = paste0("../Output/calculations_report_content_", params$year, "_", today_date, ".xlsx")
