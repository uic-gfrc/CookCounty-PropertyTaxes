...
no_incents <- n_distinct(muni_ratechange_full$clean_name[muni_ratechange_full$change_noInc == 0])
median = round(muni_count/2)
median_5 = c( (median-2) : (median+2) )
bottom_5 = c( (muni_count-4) : muni_count )
...
paper_tables <- list(
  ...
  "Table 8" = muni_ratechange, # if assessment ratio was 25% instead of 10%
  "Table 9" = muni_ratechange, # if properties with incentives were vacant (i.e. 0 FMV)
