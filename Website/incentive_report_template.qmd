...
cross_county_line <- c("Frankfort", "Homer Glen",  "Oak Brook", "East Dundee", "University Park",  
...
cook_ratechange <- pin_data %>%
  filter(!clean_name  %in% c("Frankfort", "Homer Glen",  "Oak Brook", "East Dundee","University Park", 
                             "Bensenville", "Hinsdale", "Roselle",
                             "Deer Park", "Deerfield",
                             "Buffalo Grove",  "Bartlett",  "Burr Ridge", "Hanover Park", "Steger")) %>% 
