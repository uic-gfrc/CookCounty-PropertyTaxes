...
#| caption: "Summary of homestead exemptions in Cook County (Tax Year 2021)"
...
tbl |> flextable::flextable()
 # DT::datatable(caption = "Summary of homestead exemptions in Cook County (Tax Year 2021)")

```

Eq_AV is the 2021 equalization factor multiplied by the assessed value of all property and can be thought of as "EAV pre-exemption."
The general homestead exemption accounts for the vast majority of exempt EAV.
...
#| tbl-cap: "Total Exempt EAV in 2021 in the City of Chicago and the Suburbs"
