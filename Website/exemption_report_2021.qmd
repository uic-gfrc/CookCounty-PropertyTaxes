...
#| tbl-cap: "**Summary of Homestead Exemption Use in Cook County (Tax Year 2021)** Eq_AV is the 2021 equalization factor multiplied by the assessed value of all property and can be thought of as EAV pre-exemption. The general homestead exemption accounts for the vast majority of exempt EAV. Dollar amounts in millions of "
...
#| fig-cap: "**Summary of Homestead Exemption Use in Cook County (Tax Year 2021)** Eq_AV is the 2021 equalization factor multiplied by the assessed value of all property and can be thought of as EAV pre-exemption. The general homestead exemption accounts for the vast majority of exempt EAV."
