...
The file `comm_ind_inmunis_timeseries_2006to2024.csv` contains all PINs that had an incentive property class for at least 1 year. It includes all observations for a property during the years that it existed, even if it is not an incentive class property in that year. 
...
comm_ind_pins <- read_csv("../Output/comm_ind_PINs_2006to2024_timeseries.csv")
...
```{r}
#| label: fig-incentive-pin-counts-allyears
#| fig-cap: "Commercial and industrial PINs with incentive classifications by tax year"
#| column: margin
...
```{r}
#| label: fig-pincount
#| fig-cap: "Growth in commercial and industrial incentive PIN counts, indexed to 2011"
#| column: margin
...
muni_MC <- read_csv("../Output/ptaxsim_muni_class_summaries_2006to2024.csv") %>%
...
```{r}
#| label: tbl-incentive-pin-counts-duplicate
#| tbl-cap: "Commercial and industrial incentive PIN counts and shares by tax year"
table <- comm_ind_pins %>% 
    filter(land_use %in% c("Industrial", "Commercial")) |>
...
#| 
cook_mc <- read_csv("../Output/ptaxsim_muni_MC_2006to2023.csv") |> 
