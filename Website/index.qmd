# Exemptions and Incentives in Cook County's Property Tax System: Who Bears the Benefits and Burdens? {#sec-background-info .unnumbered}
...
<!--- I do not think we want the YAML's default title and authors' names on this page. We should put them directly into the document --->
...
*Government Finance Research Center Department of Public Policy, Management, and Analytics, University of Illinois Chicago*

Michael Van Hulle

*Networks & Governance Lab, Department of Public Policy, Management, and Analytics, University of Illinois Chicago*
...
***Do we want/need anything below this point?***
...
MVH Comment: Is that in latex because thirsty...
