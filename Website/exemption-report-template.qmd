...
#| label: tbl-Table3
#| column: page
#| tbl-cap: "**Report Table 3. Estimated Bill Change for a municipality's median valued property if exempt EAV from the GHE were added to back to the tax base.**"
