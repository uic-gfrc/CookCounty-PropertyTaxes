...
county_sums <- read_csv("../Output/ptaxsim_cook_level_2006to2023_new.csv")
...
muni_ratechange <- read_csv(paste0("../Output/muni_ratechange_", params$year, ".csv"))
...
mc_burden <- read_csv(paste0("../Output/muni_mc_burden_", params$year, ".csv"))


burden_shift <- read_csv(paste0("../Output/muni_burden_shift_", params$year, ".csv"))
```
