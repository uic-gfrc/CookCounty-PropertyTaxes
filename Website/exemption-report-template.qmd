...
#| fig-cap: !expr paste0("**Exempt EAV in Cook County** Exemption use varies between suburban Cook County(", geo_sums$`Exempt EAV`[Geography==Suburbs], "EAV) and the City of Chicago (", geo_sums$`Exempt EAV`[Geography==Suburbs], "EAV), which may point to broader socioeconomic patterns as well as residents' eligibility and update. Note: Our current calculations undervalue the disabled veterans exemption. Note: Our current calculations undervalue the disabled veterans exemption.")
