...
#| fig-cap: "**Share of EAV that is tax exempt due to homestead exemptions. Denominator is a municipality's residential EAV.**"
#| eval: false
...
median_exempt <- muni_mc_sums |>
  filter(year== params$year)|>
  group_by(clean_name) |>
  summarize(muni_pct_eav_exempt =( eav[major_class_code == "2"] - eav_taxed[major_class_code == "2"] )/  eav[major_class_code == "2"])  |> 
  select(muni_pct_eav_exempt, clean_name)
...
#           )
# 
# breaks = c(0.075, 0.15, 0.225, 0.30, as.numeric(max(median_exempt$muni_pct_eav_exempt)) ) 
# 
# colors = c( "#ffffcc",
#                       "lightblue",
#                       "#1d91c0", 
...
print(median_exempt |>
        ...
        scale_fill_manual(
         # values = colors,
        # values = c(0.075, 0.15, 0.225, 0.30, as.numeric(max(median_exempt$muni_pct_eav_exempt)) ),
          # colors = c( "#ffffcc",
          #             "lightblue",
          #             "#1d91c0",
          #               "navy",
