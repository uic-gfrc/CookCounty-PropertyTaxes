...
ptax_pins <- read_csv(here("Output", "Dont_Upload", "0_joined_PIN_data_2022.csv")) %>% 
...
burden %>% 
  ...
  scale_fill_brewer(palette="Paired", labels = c("Current Rate", "If LoA 25%", "If Vacant"), direction = 1)+
