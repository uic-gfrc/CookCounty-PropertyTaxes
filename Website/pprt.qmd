...
```{r}
#| label: fig-state-transfers-local-governments
#| fig-cap: "Illinois state transfers to local governments by transfer program and fiscal year"
...
```{r}
#| label: fig-pprt-transfers-local-governments
#| fig-cap: "Personal Property Replacement Tax expenditures transferred to local governments by fiscal year"
...
```{r}
#| label: fig-income-tax-and-pprt-revenue
#| fig-cap: "Illinois income-tax and Personal Property Replacement Tax revenue trends by fiscal year"
