...
```{r}
#| fig-cap: "Uses final_tax_to_tif_AWM for TIF increment calculation. Has adjusted exemption values and calculating allvalues from the pin datatable instead of using ptaxsim::tax_bill() values. Would be more correct than original ways values were calculated."
