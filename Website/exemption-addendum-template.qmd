...
pin_data %>% 
  ...
  scale_y_continuous(label = scales::dollar, limits = c(0,600000000)) + 
  theme_classic() + 
  #  scale_fill_discrete(name = "EAV", labels = c("Exempt EAV", "Taxed EAV"), guide = guide_legend(reverse=TRUE)) +
  labs(x = element_blank(), y = "Non-TIF Increment EAV in Municipality")
```
...
There are `r scales::comma(mil_home_count$million_dollar_homes)` million dollar homes that did claim the GHE.
