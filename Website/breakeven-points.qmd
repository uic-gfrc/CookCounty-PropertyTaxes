...
Bills were pulled from PTAXSIM and summed to the pin level in files `1_...rmd` and `2...rmd`. Exemption data per PIN was pulled from PTAXSIM in file `3_.....rmd`.
...
```{r}
#| label: fig-breakevenToAV-casestudies
#| echo: FALSE
...
nochange %>%
  ...
  geom_point() +
  geom_abline(aes(slope = 1, intercept = 0), lty = 2, alpha = .4)+
...
```{r}
#| label: billdistributions-phoenix
#| layout-ncol: 2
