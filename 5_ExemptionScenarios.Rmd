...
Class2_Scenario_burdenshift <- Class2_merged %>% 
  ...
  mutate(Class2_scenario1_taxable_eav = Class2_Total_EAV - Class2_TIF_increment_EAV - Class2_homeowners_exemption,
        Class2_scenario2_taxable_eav = Class2_Total_EAV - Class2_TIF_increment_EAV - (Class2_senior_exemption + Class2_freeze_exemption )) %>%
...
532 million for only offsetting impacts of general homeowners exemption and 
