...
col_name_map <- c(
  #term = "",
  av_clerk = "Final AV",
  years_existed = "Years PIN Exists",
  fmv = "FMV",
  base_year_fmv_2006 = "FMV in 2006",
  base_year_fmv_2011 = "FMV in 2011"
)
...
labels_4fn <- c(
  #"PIN Count", "Min. FMV", "25th Quantile", "50th Quantile", "75th Quantile", "Max. FMV", "Avg. FMV", "Total FMV", "PIN Count",
              #  "Variables", 
                "Final AV",  "Years PIN Exists", "FMV", "FMV in 2006", "FMV in 2011"
                )
...
#| fig-cap: "Scatterplots: FMV against Base Year FMV (by Year)"
#| fig-cap-location: top

comm_ind |>
  filter(year == 2022) |>
 # distinct(year, pin, base_year_fmv_2006) %>%
  ggplot() +
  geom_point(aes(x = base_year_fmv_2006, y = fmv)) +
  theme_classic()# + 
  # facet_grid(rows = vars(year), cols = vars(incent_prop))
 #  facet_wrap(~year)
