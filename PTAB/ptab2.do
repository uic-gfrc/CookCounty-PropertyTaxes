...
*****************************************************
*  this could be done with xls2dta
*   since we only have a few years of data I will do it in a more grinding fashion
*  see help xls2dta   if nicer programing is desired
*
*   it would also probably  be ok to use frames to do this.
**********************************************************************************

dir

* import excel "Levy Adjustment 2024 for PA 102-0519.xlsx", sheet("2024 Levy Adjust PA102-0519") first
* import excel "Levy Adjustment 2023 for PA 102-0519.xlsx", sheet("2023 Levy Adjust PA102-0519") first
* import excel "Levy Adjustment 2022 for PA 102-0519.xlsx", sheet("2022 Levy Adjust PA102-0519") first
import excel "Levy Adjustment 2021 for PA 102-0519 CORRECTED.xlsx", sheet("CORRECTED Levy Adj TY2021") first


just clean up and add years and append them and this should be workable
exit
