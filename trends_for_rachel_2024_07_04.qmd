...
county_summary %>% filter(year == 2022)
```
### 2021
...
#| tbl-cap: "County level stats aggregated from PIN level data. Includes ALL commercial and industrial incentive class PINs. (2022)"
...
```{r}
#| label: tbl-2021-county-incentive-sums
#| tbl-cap: "County level stats aggregated from PIN level data. Includes ALL commercial and industrial incentive class PINs. (2021)"
...
#| tbl-cap: "**Industrial and Commercial Values** Aggregated from PIN level data. Includes ALL commercial and industrial PINs. (2022)"
...
```{r}
#| label: tbl-2021-create-county-trends
#| tbl-cap: "**Industrial and Commercial Values** Aggregated from PIN level data. Includes ALL commercial and industrial PINs. (2022)"
#| 
county_trends |> 
  filter(year == 2021)
