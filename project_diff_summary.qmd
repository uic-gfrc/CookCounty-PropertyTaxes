...
twnshp_test <- comm_ind %>% 
 ...
 # filter(pin7 %in% c(2930500:2932100))
#filter(pin7 %in% c(1921113:1921400))  # stickney blocks
#filter(pin7 %in% c(3116402:3129200))
 ...
 # filter(pin7 %in% c(3116402:3116403)) |>
#filter(pin7 %in% c(3121000:3122200)) |>
#  filter(pin7 %in% c(3122300:3120301))
#filter(!pin7 %in% c(3123200:3124100) ) |> 
#filter(!pin7 %in% c(3123412:3124314) ) |>
#  filter(!pin7 %in% c(3127400:3127401) ) |>

 # filter(!pin7 %in% c(3127400:3132000) )
