...
burden_shift %>%    
 ...
 # filter(clean_name %in% c("Hometown", "Burbank", "Schaumburg", "Elk Grove Village", "Westchester") | 
           burden_change > 0.112 |burden_change < .0029 ) %>%
  ...
  labs(title = "Change in Residential Tax Burden (Class 2 Only)", 
  x = "Share of Levy (%)", y = "" )
