...
mutate(actual_keypin = case_when(
  ...
  pin %in% c(14182120371301:1418210371411) ~ "1945 Wilson LLC",
  ...
  pin %in% c(25311150050000, 25311230010000,25311150030000, 25311050220000, 25311150060000, 25311050460000,25311130110000,25311050470000, 25311130220000,25311130210000,25311050300000,25311050580000,25311050620000,25311050520000,25311130010000) ~ "Veterans Services",
  pin %in% c(25311050220000: 25311230010000) ~ "Veterans Services",
  pin %in% c(15212000180000:15212041520000) ~ "Westchester Rising LLC",
  pin %in% c(25311050220000: 25311230010000) ~ "Western Avenue Realty LLC",
