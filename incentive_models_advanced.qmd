...
ind_list <- list(
  ...
  land_use_model <- plm(fmv_growth_2011 ~ prop_use_change_bin,
                           model = "within",
                           effect = "twoways",
                           data = ind_panel_muni),
  
  incentive_change_model <- plm(fmv_growth_2011 ~ incent_change_bin,
                                  model = "within",
                                  effect = "twoways",
                                  data = ind_panel_muni)
  
  incentive_interact_model <- plm(fmv_growth_2011 ~ incent_change_bin + prop_use_change_bin
