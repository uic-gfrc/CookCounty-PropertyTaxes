...
comm_ind <- comm_ind |>
  ...
  mutate(fmv_2011 = as.numeric(as.character(fmv_2011)),
         fmv_growth_2011 = as.numeric(as.character(fmv/fmv_2011)))
...
comm_ind_panel_pin <- pdata.frame(comm_ind_temp, index = c("year", "pin"))
...
pin_fe_models <- list(
  ...
  pin_fe_model_1 = plm(fmv_growth_2011 ~ lag(incent_prop),
                       model = "within",
                       effect = "twoways",
                       data = comm_ind_panel_pin),
  
  pin_fe_model_1 = plm(fmv_growth_2011 ~ lag(incent_prop) + land_use,
                       model = "within",
                       effect = "twoways",
                       data = comm_ind_panel_pin)
        )
...
muni_fe_models <- list(
  ...
  pin_fe_model_2 = plm(fmv_growth_2011 ~ lag(incent_prop) + land_use,
                       model = "within",
                       effect = "twoways",
                       data = comm_ind_panel_muni),
  
  pin_fe_model_3 = plm(fmv_growth_2011 ~ lag(incent_prop) + land_use + fmv_2011,
                       model = "within",
                       effect = "twoways",
                       data = comm_ind_panel_muni),
  
  pin_fe_model_5 = plm(fmv_growth_2011 ~ lag(incent_prop) + land_use + fmv_2011 + 
                         + in_tif,
                       model = "within",
                       effect = "twoways",
                       data = comm_ind_panel_muni)
