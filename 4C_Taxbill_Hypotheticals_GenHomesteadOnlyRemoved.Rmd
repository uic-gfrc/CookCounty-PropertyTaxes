...
```{r}
pin_data <- read_csv("4C_joined_PINs_bills_and_exemptions.csv")
...
write_csv(pin_data2, "4C_joined_PINs_bills_and_exemptions.csv")
```
...
muni_taxrates %>% write_csv("4C_muni_taxrates.csv")
```
